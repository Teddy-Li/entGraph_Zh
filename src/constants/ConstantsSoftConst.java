...
public class ConstantsSoftConst {
	...
	public static int numIters = 5;//4 for TACL experiments
	// public static double lmbda = .001;// lmbda for L1 regularization
	public static double lmbda = .0001;// lmbda for L1 regularization //.01 for ALL TACL experiments
...
//	public static String tPropSuffix = "_rw_lm1_0_reg_inf_1_thr_0_selfE.txt";
	public static String tPropSuffix = "_binc_%d_1e-4_1e-2.txt";
